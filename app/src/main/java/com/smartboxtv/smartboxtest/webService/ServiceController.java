...
public class ServiceController {
     ...
     * URLs                                                                         *
     ********************************************************************************/
    public static String URL_BASE = "http://fxservicesstaging.nunchee.com";
    public static String BASIC = "cHJ1ZWJhc2RldjpwcnVlYmFzZGV2U2VjcmV0";
        ...
        switch (code) {
            case ServiceController.CODE_401_CLIENT_ERROR:
                CustomMessage.get(context,
                        ...
                        .show();
                return false;
            case ServiceController.CODE_404_CLIENT_ERROR:
                CustomMessage.get(context,
                        ...
                        .show();
                return false;
            case ServiceController.CODE_400_CLIENT_ERROR:
                CustomMessage.get(context,
                        CustomMessage.TYPE_PROBLEMS,
                        ...
                        .show();
                return false;
            case ServiceController.CODE_500_SERVER_ERROR:
                CustomMessage.get(context,
                        CustomMessage.TYPE_PROBLEMS,
